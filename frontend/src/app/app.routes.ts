...
import { AdminContableComponent } from './pages/admin-contable/admin-contable';
...
export const routes: Routes = [
  ...
  { path: 'admin/contable', component: AdminContableComponent, canActivate: [authGuard, adminGuard] },
